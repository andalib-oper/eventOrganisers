      ...
      <ScrollView>
        <View
          ...
          <Text
            ...
            Please Click On the button To Scan The QR Code
          </Text>
          {!scan && ScanResult && (
            <View>
              <TouchableOpacity
              ...
              {/* <View style={styles.ticketDetailsView}>
                <Text style={styles.ticketText}>Total Tickets Sold</Text>
                <Text style={styles.ticketText}>Total Check In </Text>
                <Text style={styles.ticketText}>Total Revenue</Text>
                <Text style={styles.ticketText}>Commission amount </Text>
                <Text style={styles.ticketText}>Net Amount</Text>
              </View> */}
            </View>
          )}
        </View>
        {!ScanResult && (
          <View>
            <View>
              ...
              <EventTable name="Ticket Number" map={result?.ticket?._id} />
              <EventTable name="Event Name" map={result?.ticket?.name} />
              <EventTable name="Age" map={result?.ticket?.age} />
              <View
                style={{
                  flexDirection: 'row',
                }}>
                  ...
                  <Modal
                    ...
                    <View style={styles.modalView}>
                      ...
                      <Pressable
                        ...
                        onPress={() =>
                          onReject(setModalVisible(!modalVisible))
                          // onReject()
                        }>
